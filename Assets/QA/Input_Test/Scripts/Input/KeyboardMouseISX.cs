...
public class KeyboardMouseISX : MonoBehaviour
{
    ...
    void Start()
    {
        m_keyboardAction = new InputAction(name: "KeyboardPressAction", InputActionType.PassThrough, binding: "<keyboard>/<key>");
        m_keyboardAction.performed += callbackContext => KeyboardKeyPress(callbackContext.control as KeyControl);
        m_keyboardAction.Enable();

        m_mouseButtonAction = new InputAction(name: "MouseButtonAction", InputActionType.PassThrough, binding: "<mouse>/<button>");
        ...
        m_mouseOtherAction = new InputAction(name: "MouseVector2Action", InputActionType.PassThrough, binding: "<mouse>/<vector2>");
